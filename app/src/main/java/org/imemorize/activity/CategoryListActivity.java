                ...
                if(selectedCat!=null){
                        ...
                        switch (selectedCat.id){
                            case  CONST_USER_QUOTES_ID:
                                if(app.getNumberOfUserQuotes()<1){
                                    Toast.makeText(mContext,getString(R.string.prompt_no_user_quotes), Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                break;
                            case  CONST_USER_FAVORITES_ID:
                                if(app.getNumberOfFavorites()<1){
                                    Toast.makeText(mContext,getString(R.string.prompt_no_favorites), Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                break;
                            case  CONST_USER_MEMORIZED_ID:
                                if(app.getNumberOfMemorized()<1){
                                    Toast.makeText(mContext,getString(R.string.prompt_no_memorized), Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                break;
                        }
                    ...
                    if(catList.size()<1){
                        ...
                        if(quoteList!=null){
                            ...
                            Toast.makeText(mContext,"no quotes",Toast.LENGTH_SHORT).show();
                        }
                    }else{
